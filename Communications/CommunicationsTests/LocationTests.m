...
- (void)test_initWithDecimalLatitude_Longitude
{
    ...
    Location* testLocation = [[Location alloc] initWithDecimalLatitude: latitude Longitude: longitude];
...
- (void)test_initWithIntegerLatitude_Longitude
{
    ...
    Location* testLocation = [[Location alloc] initWithIntegerLatitude:latitude Longitude:longitude];
    XCTAssertNotNil(testLocation, @"Test Location not constructed");
